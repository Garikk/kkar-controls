...
public abstract class kk_DefaultConfig {
    public static ControlsConfig MakeDefaultConfig() {
        ...
        DefConf.Controls[12].Name="CUSTOM_CHRY_AMFM_AMFM";
        DefConf.Controls[12].buttonID.add("CUSTOM_CHRY_AMFM_AMFM");
        DefConf.Controls[12].buttonID.add(DEF_BTN_BACK);
        DefConf.Controls[12].AdapterSource="A"; 
        
        DefConf.Controls[13].Name="CUSTOM_CHRY_AMFM_SET";
        DefConf.Controls[13].buttonID.add("CUSTOM_CHRY_AMFM_SET");
        DefConf.Controls[13].buttonID.add(DEF_BTN_ENTER);
        DefConf.Controls[13].AdapterSource = "S";

        DefConf.Controls[14].Name = "CUSTOM_CHRY_CLOCK_H";
        DefConf.Controls[14].buttonID.add("CUSTOM_CHRY_CLOCK_H");
        DefConf.Controls[14].AdapterSource = "H";

        DefConf.Controls[15].Name = "CUSTOM_CHRY_CLOCK_M";
        DefConf.Controls[15].buttonID.add("CUSTOM_CHRY_CLOCK_M");
        DefConf.Controls[15].AdapterSource = "M";
